...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private int PetEditorLoaderID = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.getData() != null){
            ...
            getLoaderManager().initLoader(PetEditorLoaderID,null,this).forceLoad();
        }
        else{
    ...
    private void savePet(){
        ...
        if( mCurrentPetUri == null ){
            ...
            if(insertUri == null) {
                ...
                Log.i("Editor Activity","New row ID: " + newRowID);
            }
        }else{
            long rowsUpdated = getContentResolver().update(mCurrentPetUri,values,null,null);
            if(rowsUpdated == 0 ){
    ...
    private void deletePet(){
        int nPetDeleted = getContentResolver().delete(mCurrentPetUri,null,null);
        if( nPetDeleted > 0 ) {
            Toast.makeText(this, "Pet successfully deleted", Toast.LENGTH_SHORT).show();
            finish();
        }
        else
            Toast.makeText(this,"Pet cannot be deleted",Toast.LENGTH_SHORT).show();
    }


    private void showDeletePetDialog(DialogInterface.OnClickListener cancelButtonClickListener){
        // Create an AlertDialog.Builder and set the message, and click listeners
        // for the positive and negative buttons on the dialog.
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Delete Pet");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                ...
                showDeletePetDialog(cancelButtonClickListener);
//                finish();
                // Do nothing for now
                return true;
        }
